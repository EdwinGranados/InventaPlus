...
?>
    <form action='../controller/usuariosController.php?tipoRegisto=C' method="POST" class="mt-5"
        ...
        <div class="mb-3  mt-5">
            ...
            <input type="text" class="form-control" id="usu" aria-describedby="usuarioHelp" name="usuario">
        ...
        <div class="mb-3">
            ...
            <input type="checkbox" name="act" id="act" checked='true'>
        </div>
...
?>
    <form action='../controller/usuariosController.php?tipoRegisto=A' method="POST" class="mt-5"
        ...
        <div class="mb-3  mt-5">
            <label for="usuario" class="form-label">Usuario</label>
            <input type="text" class="form-control" id="usu" aria-describedby="usuarioHelp" name="usuario" value="<?=$ref[1]?>">
            <div id="usuarioHelp" class="form-text"></div>
        </div>
        <div class="mb-3">
            <label for="act" class="form-label">Activo</label>
            <input type="checkbox" name="act" id="act" checked="<?php($ref[3]==1)?'true':'false';?>">
        </div>
